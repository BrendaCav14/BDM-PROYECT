...
<h2  style='margin-left:200px; margin-top: 15px;'>Cantidad: ".$prod['cantidad']."</h2>  </h2>
  ...
  <br>
  <h2>Comentario:</h2>
  <div> <input type='text' name='comentario[]' id='comentario' class='form-control' id='coment' name='coment' style='font-size:20px; background-color:#ececec; color:blue; height:35px;' placeholder='Escriba un comentario' autocomplete='off' required></div>
