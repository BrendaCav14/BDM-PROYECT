    ...
    .then((result) =>{
        ...
        if(result.isConfirmed){
            ...
            .then(response => response.text()).then(response => {
                ...
                window.location.href = 'MisListas.php';
            }
...
foreach($res as $data){
  ...
  <div class='custom-column' style='background-color:#b7acac; border-radius: 10%; border:3px; border-color:black; border-width:thick;  height:450px; width:900px; margin-top:10px; margin-left:60px;'>
...
<br></br>
    <h6 class='card-title' id='nomprod' style='font-size:25px; font-family: Times New Roman, Times, serif; font-weight:bold; max-width:600px; max-lenght:600px; text-overflow: ellipsis; line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 1; '>".$data['Producto']."</h6>
    <h3>Descripcion</h3>
