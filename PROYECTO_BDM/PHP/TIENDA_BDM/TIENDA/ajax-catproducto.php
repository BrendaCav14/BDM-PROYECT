...
if($_POST) {
    ...
    $buscar = $_POST["getProducts"];

require("./BACKEND/Connection.php");

$consulta= $pdo->prepare("CALL SP_Categoria('O',null, :id,null,null);");
$consulta->bindParam(":id", $buscar);
$consulta->execute();
...
if($buscar != "nada"){
  ...
  echo "
      ...
      <p style='font-size:15px'> Precio: $".$row['precio']." </p>
          ...
          <a href='Producto.php?id=".$row['ID_Producto']."&usu=".$_SESSION['ID_usuario']." ' class='btn btn-primary btn-lg'>Ver Producto</a>
          </div>
    ...
    $consulta= $pdo->prepare("CALL SP_Busqueda('D',null);");
    $consulta->execute();
