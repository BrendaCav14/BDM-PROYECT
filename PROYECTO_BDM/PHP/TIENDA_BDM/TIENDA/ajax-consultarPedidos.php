...
$busca= $pdo->prepare("CALL SP_VentaDet('E',:cat,:f,:fin,null,null,null,null,null,null,:com,null);");
$busca->bindParam(":cat", $Cat);
$busca->bindParam(":f", $f1);
$busca->bindParam(":fin", $f2);
$busca->bindParam(":com", $comp);
$busca->execute();
...
if($row['promedio'] == 1){
  ...
  <td style='width:100px;'>".$row['Cantidad']."</td>
    ...
    $busca= $pdo->prepare("CALL SP_VentaDet('G',null,:f,:fin,null,null,null,null,null,null,:com,null);");
