...
<input type="text" id="email" class="form_input" name="email" placeholder="example@outlook.com" autocomplete="true"  onkeydown="comprobarEmail()" required>
<span id="text"></span>
...
<br>
    <div class="formulario__grupo" id="grupo__usuario">
      ...
      <input type="text" id="usuario" class="form_input" name="usuario" placeholder="user123" autocomplete="true" style="width:150px;" onkeydown="comprobarUsuario()" required>
      <br>
