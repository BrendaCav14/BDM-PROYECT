...
<div class="container">
    ...
    <?php include('carrito.php') ?>
          ...
          <h1 style=" color:#D07118; font-weight: bolder; font-size:30px; margin-left:400px;">Mi Lista</h1>
          <h1 style=" color:#D07118; font-weight: bolder; font-size:30px; margin-left:400px;">Lista de Regalos</h1>
  ...
  <div class="row">
    ...
    <div class="col-sm-24 col-md-9" style="border-radius: 5% ; height:260px; width:100% background-color:#E7F3FF;">
      <div class="custom-column">
        ...
        <div class="custom-column-content" style="margin-left:50px;">
        <br>
    ...
    <div style="margin-left:800px; margin-top:-100px; color:white; font-size:30px; width:100px;">

    <a class="btn btn-primary btn-danger">Eliminar</a>
          </div>
          <a class="btn btn-primary btn-primary" style="color:white; margin-left:800px;">Ver Producto</a>
        </div>
