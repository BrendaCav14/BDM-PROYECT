...
<div class="offcanvas offcanvas-start"  data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel" >
  ...
  <img src="IMG/Imagen2.jpg" alt="Avatar" class="avatar" style="width:100px; height:100px;">
  ...
  <div class="card mt-3">
                <ul class="list-group list-group-flush">
                  ...
                  <a type="button" href="PaginaInicio.php" class="btn btn-light" style="width:100%; text-align:center; font-size:20px; color:#7B1842;">
...
<hr>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <a type="button" href="PerfilUsuario.php" class="btn btn-light" style="width:400px; text-align:center; font-size:20px; color:#7B1842;"> 
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <a type="button" href="MisListas.php" class="btn btn-light" style="width:400px; text-align:center; font-size:20px; color:#7B1842;"> 
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <a type="button"  href="MisProductos.php" class="btn btn-light" style="width:400px; text-align:center; font-size:20px; color:#7B1842;"> 
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <a type="button" href="ConsultaPedidos.php" class="btn btn-light" style="width:400px; text-align:center; font-size:20px; color:#7B1842;"> 
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="margin-top:-75px;">
            <ol >
            <a class="navbar-brand" href="PaginaInicio.php" style="color:white; font-family: Sofia, sans-serif; font-size:40px;" >Shopping ♥</a>
  ...
  <div style="color: white; font-size:13px; margin-top:-30px;">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          MENU
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="margin-left:250px; font-size:12px;">
          <a class="dropdown-item" href="Categoria.php">Crear Categoria</a>
          <a class="dropdown-item" href="Listas.php">Crear Lista</a>
          <a class="dropdown-item" href="AgregaProducto.php">Agregar un Producto</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="ConsultaVentas.php">Consultar Ventas</a>
          <a class="dropdown-item" href="ConsultaPedidos.php">Consultar Pedidos</a>
        </div>
 </div>
...
<div style="margin-top:-60px; margin-left:850px;">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="margin-left:950px;">
    ...
    <a class="dropdown-item" href="LandingPage.php" >Cerrar Sesion</a>
</div>
  </div> 
            </ol>
          </nav>
