...
<div class="main-body">
    ...
    <?php include('carrito.php') ?>
          ...
          <div style="background-color:white; width:1100px; height: 650px; margin-left:5px;">
        <br></br>
...
<br></br>
<button type="button" style="font-size:15px; width:100px;">Examinar</button>
<input type="text" id="country" style="background-color:#c5bbbb; width:200px; font-size:15px;" readonly>
...
<div style="margin-left:850px; margin-top:-130px;">
