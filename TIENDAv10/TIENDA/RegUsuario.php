...
<input type="text" id="email" class="form_input" name="email" placeholder="example@outlook.com" autocomplete="true" onkeydown="validation()" required>
<span id="text"></span>
</div>
<br>
<br>
    <div class="formulario__grupo" id="grupo__usuario">
      ...
      <input type="text" id="usuario" class="form_input" name="usuario" placeholder="user123" autocomplete="true" style="width:150px;" required>
      <span id="result"></span>
...
<br>
        <span id="StrengthDisp" class="badge displayBadge" style="width:200px; margin-left:350px;">Weak</span>
<br>
</div>
<br>
<br>
...
<div style="margin-left:250px;">
                  ...
                  <img src="IMG/Imagen1.jpg" name="avatar" id="avatar" style="margin-left:150px; margin-top:-80px;" width="100px" height="100px" alt="foto" class="usuario-foto" >
