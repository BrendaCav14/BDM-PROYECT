...
<main>
  <form class="nombreShop" style="height:100px; text-align:center; padding-top:20px;">
   ...
   <form action="Model/InsertarUsuarios.php" method="POST" enctype="multipart/form-data"class="formularioReg" id="formulario" onsubmit="event.preventDefault()">
<br>
...
<div class="form_grupo-input">
<input type="text" id="apat" class="form_input" name="apat" placeholder="Stefania" onblur="validate(2)">
     </div>
</div>
</div>
...
<div class="form_grupo-input">
<input type="text" id="nombre2" class="form_input" name="nombre2" placeholder="Cavazos" onblur="validate(3)">
  </div>
</div>
...
<br>
    <div class="formulario__grupo" id="grupo__usuario">
      ...
      <input type="text" id="contra" class="form_input" name="usuario" placeholder="brenda123" onblur="validate(6)">
...
<input type="radio" id="mujerX" name="mujerX" value="Masculino">
...
<br></br>
                  ...
                  <input type="file" style="margin-left:-200px; " name="adjunto" id="upload" onchange="readURL(this)" accept=".jpeg,.jpg,.png"  >

                  <img src="IMG/Imagen1.jpg" name="adjunto" id="usuario-foto" style="margin-left:5px; margin-top:-60px;" width="150px" height="150px" alt="usuario-foto" class="usuario-foto"><br>
                 
                  <div>

<input type="submit" name="Registrar" class="btn btn-primary btnAction" style="margin-left:-250px;" value="Registrarse">
